  ...
  <div>
    ...
    <div class="content">
      <div class="section portion45">
        ...
        <h2>【<a rel="noopener noreferrer" href="https://wholealphard.com/">{{ fromLocation.name }}<strong><em>阿法包車</em></strong></a>】Alphard包車推薦！</h2>
        <div class="text_box">
          <p>總發給您最尊榮不凡的包車體驗，享受最高檔的旅程就選阿法包車吧！總發阿法包車提供您最高檔新穎Alphard車款，適合用於: 機場接送、商務接送、家庭包車出遊、租alphard一日遊、多日遊、環島旅遊、隱私醫美旅行、企業活動包車…等服務，帶給您最大器體面的移動方式。</p><p>除此之外，我們還提供包車服務(包車附駕駛)，適合結婚禮車、儀式禮車、活動用車等多元接送服務；專業司機熟悉{{ fromLocation.name }}，給您最穩重可靠的駕駛服務，安全準時將您送達指定的目的地。</p><p>皆依政府規定車輛均有定期檢查，並投保高額乘客保險。契約費用透明化，絕不隨意亂喊價或是添加額外費用，讓您安心搭乘無負擔。</p>
          阿法包車：
          <h3><a rel="noopener noreferrer"
              href="https://wholealphard.com/alphard/"><strong><em>{{ fromLocation.name }}包車自由行</em></strong></a>
          </h3>
          、<a rel="noopener noreferrer"
            href="https://wholealphard.com/alphard-chartered/"><strong>Alphard商務包車</strong></a><br />
          阿法包車：
          <h3><a rel="noopener noreferrer"
              href="https://wholealphard.com/portfolio/"><strong><em>包車</em></strong></a>
          </h3>
          、<a rel="noopener noreferrer"
            href="https://wholealphard.com/"><strong>結婚禮車</strong></a>、<strong>花蓮-墾丁/墾丁-花蓮專線</strong><br />
          接機、送機首選：
      ...
      <div class="section portion45">
        <div class="jumbotron">
          ...
          <h3>最優惠的阿法包車價格</h3>
          相較於其他包車服務平台，多數需要複雜手續費和抽佣，我們的團隊則由車主直接報價，繞過所有中間環節，為旅客提供最優惠的阿法包車價格，價格保證市場最划算，我們也承諾不會嵌入任何未告知的隱藏收費。
          <h3>立即暢通的客訴管道</h3>
          為免遊客於旅途中，與司機溝通不順，或司機行為失當等等情事，可隨時用官方通訊軟體，總部會立即更換車輛，並視情況補償損失，絕不讓我方駕駛之失誤，影響遊客興致，務必讓此趟行程，載滿美好回憶而歸。
          <h3>專業司機(包車限定)</h3>
          注重客戶感受，定期進行內部教育訓練，提升我們的阿法包車服務品質！多年來導覽經驗，有什麼好吃好玩的務必讓您知道，成為您在當地最佳旅遊夥伴。
          <h3>不斷創新的精神</h3>
      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: `無論是高端企業商務包車、尊爵不凡阿法包車旅遊，還是定期的醫療或醫美需求，${this.fromLocation.name}出發僅需$起，保證無菸車。專業客服讓您輕鬆建立行程，享受專屬的阿法包車服務。我們另有提供包車附駕駛（包車）讓您的寶貴時間不再因為不熟悉${this.fromLocation.name}而找不到路、或是在大眾運輸上浪費時間，立刻輕鬆體驗舒適便捷的阿法包車與包車接送。`
        },
        {
          hid: 'og:title',
          property: 'og:title',
